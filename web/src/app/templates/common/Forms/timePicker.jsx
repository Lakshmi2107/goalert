...
const useStyles = makeStyles((theme) => ({
 ...
 const PaaSTimePicker = ({ dispLabel, errorState, formDetails, disabledStatus, currentValue, onTextChange, errors, groupInfo, onCheckAvailabilityCB, fieldWidth, originalData, rowsMax }) => {
